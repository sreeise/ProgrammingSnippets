...
elements 1 unit to the left. For example, if left rotations are performed
...
function rotLeft(a, d) {
    // On each loop remove the first element in the array
    // and then push it onto the end of the array.
    for (let i = 0; i < d; i++) {
        let n = a.shift();
        a.push(n);
    }
