 ...
 */
  ...
  /**
   * Print objects in a collection. Because we use the wildcard: ?,
   * we are able to print any collection regardless of type.
  ...
  /**
   * Add objects of any type from a collection to an array through
   * the use of generic types. This could not be done if the array
   * were specified as an Object, only as a generic.
   ...
   * Array out of bounds errors could be thrown here.
   * This will work for arrays that have room for the element
   * or a dynamically resizable array.
   *
   * Lower bounded wildcard using keyword super.
   * Adds the last element in the collection to the array
   * in class GenWild
